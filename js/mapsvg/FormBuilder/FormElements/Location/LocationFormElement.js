...
import { GeoPoint } from "../../../Location/Location.js";
...
export class LocationFormElement extends FormElement {
    ...
    renderMarkerSelector() {
        ...
        this.domElements.markerSelector = $(this.domElements.markerSelectorWrap).find(".mapsvg-marker-images")[0];
        ...
        if (!this.formBuilder.editMode) {
            ...
            $(this.domElements.markerSelector).on("click", ".mapsvg-marker-image-btn-choose", function (e) {
                e.preventDefault();
                const src = $(this).find("img").attr("src");
