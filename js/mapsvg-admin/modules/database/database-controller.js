(function ($, window, MapSVG) {
    ...
    MapSVGAdminDatabaseController.prototype.toggleButtons = function () {
        ...
        this.toolbarView.find("#mapsvg-btn-csv-import").toggle(!this.isDbConnectedToPosts);
        ...
        $("#mapsvg-data-menu a")
            .click(function (e) {
                ...
                if ($(this).attr("href") === "#mapsvg-data-source") {
                    _this.admin.slideToController(_this, "databaseSource", "back");
                    return false;
                }
                $(this).tab("show");
            })
        ...
        if (
            ...
            for (var field_name in _this.mapsvg.objectsRepository.query.filters) {
                ...
                if (field_name === "regions") {
                    filterVals = _this.mapsvg.objectsRepository.query.filters[
                        field_name
                    ].region_ids.join(", ");
